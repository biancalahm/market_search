...
class GeminiService:
    ...
    def extrair_produto_etiqueta(self, imagem_bytes: bytes) -> str:
        ...
        Olhe para a foto desta etiqueta de preço e extraia APENAS o nome do produto  Deve ser o nome GENÉRICO e LIMPO  sem marca, tipo e peso limpo e genérico do produto principal e o valor de Varejo.
